...
/**
 * Página de callback OAuth2 do QuantoVale.
 * URLs registradas: https://conectcampo.digital/callback
 *                   https://conectcampo.digital/oauth/callback
 *
 * O QuantoVale redireciona para cá com ?code=XXX&state=YYY após o usuário autorizar.
 * Esta página troca o código por tokens via API do ConectCampo e redireciona para o dashboard.
 */
    ...
    async function exchange() {
      try {
        await api.post('/quantovale/exchange', {
          code,
          // Usa a mesma redirect_uri registrada no QuantoVale
