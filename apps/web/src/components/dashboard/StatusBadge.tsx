...
const statusConfig: Record<string, { label: string; className: string }> = {
  ...
  EXPIRED: { label: 'Expirada', className: 'bg-gray-100 text-gray-500 dark:bg-gray-800 dark:text-gray-400' },
  NEGOTIATING: { label: 'Em negociação', className: 'bg-cyan-100 text-cyan-700 dark:bg-cyan-900/30 dark:text-cyan-400' },
  // Roles
